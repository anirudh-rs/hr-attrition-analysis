...
Built as a portfolio data science project demonstrating end-to-end ML pipeline
development, HR domain knowledge, explainable AI, and interactive dashboard design.

**Live app:** https://hr-attrition-analytics-dashboard.streamlit.app/
